...
export { patchCommand, getNonEmptyString, getNonEmptyStringOrUndefined, getNonEmptyStringOrFunctionOrUndefined, getNonEmptyStringOrArrayOfAsArray, getObject, ensureListOfNonEmptyString, ensureListOfString, ensurePortNumber, checkTimeval, getFn, Failure, throwWithMethod };
