...
var spawn = createCommonjsModule(function (module, exports) {
'use strict';
...
var _Promise = _interopDefault(promise);
...
var spawn$1 = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(o) {
    var _ref2, cmd, _ref2$args, args, options;

    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _ref2 = o || false, cmd = _ref2.cmd, _ref2$args = _ref2.args, args = _ref2$args === undefined ? [] : _ref2$args, options = _ref2.options;
            ...
            throw new Error('spawn-async: cmd not non-empty string');
          ...
          case 5:
            return _context.abrupt('return', new _Promise(function (resolve, reject) {
              debugger;return child_process.spawn(cmd, args, _extends$$1({ stdio: ['ignore', 'inherit', 'inherit'] }, options)).once('close', function (status, signal) {
...
var spawn$1 = unwrapExports(spawn);
...
class Class {
  async run(args) {
    ...
    console.log(`Class spawn: ${util.inspect(spawn$1, { colors: true, depth: null })}`);
    const value = await spawn$1({ cmd: 'date' });
...
function classRunner({ construct, cArgs, args, stack }) {
  return (async () => {
...
This source code is licensed under the ISC-style license found in the LICENSE file in the root directory of this source tree.
*/
classRunner({ construct: Class, args: process.argv.slice(2) });
