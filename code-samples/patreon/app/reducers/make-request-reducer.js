...
export const makeRequestPendingReducer = ([requestActionType, successActionType, failureActionType], resetActionType) => {
...
export const makeRequestErrorReducer = ([requestActionType, successActionType, failureActionType], resetActionType) => {
    // _validateRequestActions(requestActionType, successActionType, failureActionType)
...
// WEBPACK FOOTER //
// ./app/reducers/make-request-reducer.js