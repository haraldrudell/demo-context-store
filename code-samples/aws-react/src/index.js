...
const name = String(Object(packageJson).name || 'Unknown')
const awsName = String(awsmobile.aws_project_name || 'Unknown')
const m = `module: ${name} awsProject: ${awsName}: index.js`
console.log(m, new Date().toISOString())
