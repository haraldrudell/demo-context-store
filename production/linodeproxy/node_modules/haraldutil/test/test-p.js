// test-p.js
// © 2012 Harald Rudell <harald.rudell@therudells.com> MIT License
...
exports['P:'] = {
	...
	'Q Values': function () {
		...
		for (var expression in tests) {
			...
			console.log = cl
			var actual = output.substring(output.indexOf(this.test.title) + this.test.title.length + 1)
			if (actual != tests[expression]) console.log('Actual: ' + actual + ' Expected: ' + tests[expression])

			assert.equal(actual, tests[expression], 'Actual: ' + actual + ' Expected: ' + tests[expression])
		}
	},
	'PS': function () {
		var aLogs = 0
