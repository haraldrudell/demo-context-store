...
function getApiRequire(state, theRequire) {
	...
	function apiRequire(moduleName) {
		...
		/*
		If prototype was updated in the api module, we need to update it, too
		apilist has the name of the export
		we have the export object
		*/
		require('./apilist').updatePrototype(result)
		...
		function tryRequire(moduleName) {
			try { // node.js require
				...
				var o = e[arguments.callee.name]
				if (!o) o = e[arguments.callee.name] = {}

				if (e.code !== 'MODULE_NOT_FOUND') {
					o.reason = 'does not have code'
					throw e // some other trouble than module not found
				}

				if (e.moduleName) {
					o.recursive = true
					throw e // a recursive module not found
				}
