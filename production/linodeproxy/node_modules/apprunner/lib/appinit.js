...
// © 2012 Harald Rudell <harald.rudell@therudells.com> (http://haraldrudell.com) MIT License
...
function getHaraldOpsData(defaults) {
	...
	if (typeof init.appFolder === 'string' && init.appFolder) jsonData.haraldopsAppFolder = init.appFolder
