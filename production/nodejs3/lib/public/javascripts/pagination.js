// https://github.com/davidwparker/jquery-bottomless-pagination/blob/master/jquery.bottomlesspagination.jshttps://github.com/davidwparker/jquery-bottomless-pagination/blob/master/jquery.bottomlesspagination.js
// http://jquery.com/
// jquery uses tabs for indentation
// http://www.otakdodol.com/2010-06/23-best-jquery-facebook-style-plugins/

(function($){
  var settings;

  // this exports the anonymous function out of this execution context
  // the settings variable becomes saved in a closure
  $.bottomlessPagination = function(callerSettings) {
      
    // settings is the object literal extended with cellerSettings
    settings = $.extend({
      // the path in the server uri space where are loading throbber image is stored
