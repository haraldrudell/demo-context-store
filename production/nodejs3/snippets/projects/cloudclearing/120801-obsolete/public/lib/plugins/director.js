ig.module(
    ...
    .defines(function(){
                 ...
                 ig.Director = ig.Class.extend({
                                                   ...
                                                   init: function(theGame, initialLevels, levelNames){
                                                       this.game = theGame;
                                                       this.levels = [];
                                                       this.levelNames = levelNames;
                                                       this.currentLevel = 0;
                                                       this.append(initialLevels, levelNames);
                                                   ...
                                                   append: function(levels, levelNames){
                                                       // FIXME - allow appending levels if we need it
                                                       // this.levelNames.concat(levelNames);
                                                   ...
                                                   jumpNamed: function(lvName) {
                                                       for(i=0; i < this.levelNames.length; i++) {
                                                           if (this.levelNames[i] == lvName){
                                                               levelNumber = i;
                                                               return this.loadLevel(levelNumber);
                                                           }
                                                       }    
