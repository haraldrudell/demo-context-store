...
__twttrlr(function (using, provide, loadrunner, define) {
	...
	provide("util/donottrack", function (a) {
		using("dom/cookie", function (b) {
			a(function () {
				return b("dnt") ? !0 : /\.(gov|mil)(:\d+)?$/i.test(document.location.host) ? !0 : document.navigator ? document.navigator["doNotTrack"] == 1 : navigator ? navigator["doNotTrack"] == 1 || navigator["msDoNotTrack"] == 1 : !1
			})
		})
	});
	...
	provide("tfw/widget/tracking", function (a) {
		using("dom/cookie", "util/donottrack", "tfw/widget/guest_cookie", "tfw/widget/env", "util/decider", function (b, c, d, e, f) {
			...
			function j(a, g, j, k, l) {
				...
				var m = h[j] || h.tweetbutton,
					n = a.ownerDocument.createElement("img"),
					o = [];
				if (!k) {
					var p = g.original_redirect_referrer || document.referrer.toString();
					i(g, "referrer", p), i(g, "widget", +e.isDynamicWidget()), !l && !c() ? (i(g, "hask", + !! b("k")), i(g, "li", + !! b("twid")), i(g, d.guest_id_cookie, b(d.guest_id_cookie) || "")) : i(g, "dnt", "1")
				}
				for (var q in g) if (g.hasOwnProperty(q)) {
					var r = encodeURIComponent(q),
						s = encodeURIComponent(g[q]);
				...
				if (f.isAvailable("rufous_pixel")) {
					var t = {
						...
						u = {
							...
							event_name: j + ":impression"
						};
					for (var q in g) {
						var v = t[q];
						v && (u[v] = g[q])
					}!l && !c() && (g.twttr_li && (u.logged_in = g["twttr_li"] == "1"), u.pid = b(d.guest_id_cookie) || ""), g.status_id && (u.tweet_ids = [g.status_id]), g.twttr_widget && (u.widget = g["twttr_widget"] == "1");
					var n = a.ownerDocument.createElement("img"),
						w = Array.prototype.toJSON;
	...
	provide("tfw/widget/tweet", function (a) {
		using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "dom/textsize", function (b, c, d, e, f) {
			...
			j.prototype = new c.Base, b.aug(j.prototype, {
				...
				render: function (a) {
					var b = a.assetUrl() + "/widgets/tweet_button.1336551279.html#" + this.parameters();
		...
		using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "dom/textsize", function (b, c, d, e, f) {
			...
			g.prototype = new c.Base, b.aug(g.prototype, {
				...
				render: function (a) {
					...
					var b = a.assetUrl() + "/widgets/follow_button.1336551279.html#" + this.parameters();
